    ...
    <main className="bg-white dark:bg-gray-900 text-black dark:text-white min-h-screen transition-colors duration-300">
      ...
      <div className="flex flex-row w-full">
        <div className="w-full md:w-2/3 mx-auto px-6 md:px-0">
          ...
          <div className="my-24">
            <p className="text-xs font-mono font-bold tracking-widest text-green-500 dark:text-green-400 mb-3 uppercase">{"< ABOUT ME />"}</p>
          ...
          {/* Bio */}
          <div className="text-lg text-gray-700 dark:text-gray-300 mb-16 space-y-5 leading-relaxed max-w-2xl">
            <p>
              I graduated in 2025 from{" "}
              <span className="bg-green-100 dark:bg-green-900/40 px-1 rounded">Egypt-Japan University of Science and Technology</span>{" "}
              with a BSc in Computer Science (AI), CGPA 3.38/4.0. Based in Cairo, Egypt.
            </p>
            <p>
              ...
              By <span className="font-bold">2020</span> I was fully invested in both{" "}
              <span className="bg-green-100 dark:bg-green-900/40 px-1 rounded">web development</span> and{" "}
              <span className="bg-green-100 dark:bg-green-900/40 px-1 rounded">machine learning</span>, and I&apos;ve been building production-level projects across both domains since.
            </p>
            <p>
          ...
          {/* Quick Facts */}
          <div className="mb-16">
            <h2 className="text-2xl font-bold mb-6 text-gray-800 dark:text-white">Quick Facts</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 rounded-xl p-4">
                <p className="text-xs text-gray-500 dark:text-gray-400 mb-1 uppercase font-mono tracking-wide">Languages</p>
                <p className="font-semibold text-gray-800 dark:text-gray-100 text-sm">Arabic (Native) · English (C2, IELTS 8.5) · German (A1) · French (Basic)</p>
              </div>
              <div className="border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 rounded-xl p-4">
                <p className="text-xs text-gray-500 dark:text-gray-400 mb-1 uppercase font-mono tracking-wide">Education</p>
                <p className="font-semibold text-gray-800 dark:text-gray-100 text-sm">BSc CS (AI) — EJUST, 2021–2025, CGPA 3.38</p>
              </div>
              <div className="border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 rounded-xl p-4">
                <p className="text-xs text-gray-500 dark:text-gray-400 mb-1 uppercase font-mono tracking-wide">Currently</p>
                <p className="font-semibold text-gray-800 dark:text-gray-100 text-sm">AI Engineer Intern @ Enza Group, Cairo</p>
              </div>
              <div className="border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 rounded-xl p-4">
                <p className="text-xs text-gray-500 dark:text-gray-400 mb-1 uppercase font-mono tracking-wide">Interests</p>
                <p className="font-semibold text-gray-800 dark:text-gray-100 text-sm">Chess · Boxing · Competitive Programming</p>
              </div>
            </div>
          </div>
          ...
          {/* Spotify */}
          <div className="mb-20">
            <h2 className="text-2xl font-bold mb-6 text-gray-800 dark:text-white">All-time favourite tracks</h2>
